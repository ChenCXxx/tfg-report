...
MaskImg_path = "0604_mask\image_0217_cloth.jpg"
UnMaskImg_path = "0604_mask\image_0226.jpg"
file_dir = "0604_mask"
color = (0, 0, 255)
size = 4
...
if(flag == True):
    ...
    cv2.imwrite(file_dir + "\\" + "img_rect.jpg", img_rect)
    cv2.imwrite(file_dir + "\\" + "grabcut_output.jpg", grabcut_output)
    cv2.imwrite(file_dir + "\\" + "img_seed.jpg", img_seed)
